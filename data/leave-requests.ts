...
export function getLeaveTypeLabel(leaveType: LeaveTypeAlias, language: "en" | "tr"): string {
  const leaveTypeLabels: Record<LeaveTypeAlias, { en: string; tr: string }> = {
...
export const sampleLeaveRequests: LeaveRequestInterface[] = [
  {
    id: "leave-1",
