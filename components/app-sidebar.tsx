...
function AppSidebar() {
  ...
  const routes: SidebarRoute[] = [
    ...
    },
    {
      ...
      routes: [
        { href: "/request-approvals/spending", icon: DollarSign, label: translations.sidebar.spendingRequestManagement },
            ...
            {routes.map((category) => (
              <div key={category.key} className="mb-4">
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-md px-2 py-1.5 text-sm font-medium text-[var(--fixed-sidebar-muted)] hover:bg-[var(--fixed-sidebar-hover)]"
                >
                    ...
                    {category.routes.map((route) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {route.badge !== undefined && <Badge className="bg-[var(--fixed-primary)] text-white">{route.badge}</Badge>}
                        </Link>
                      )
                    })}
                  </div>
